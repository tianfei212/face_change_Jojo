...
input_options = ["webrtc_client", "rtsp"] if not has_local_cam else ["webrtc_client", "local_cam", "rtsp"]
input_type = st.sidebar.selectbox("输入源", input_options)
...
raw_preview = st.sidebar.checkbox("仅原始预览（减少卡顿）", value=True)
